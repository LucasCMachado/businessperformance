	...
	case 1:
        ...
        $validacao=$stmt->fetch();
            ...
            if ($validacao['validaFormulario']>0) {
                ...
                header("location: assessment-respondido-".$_POST['tokenForm']."-".$_POST['tokenCliente']."");
                                        ...
                                        <div class="">
                                            ...
                                            <div>
                                                ...
                                                <div style="font-family:Gotham-Medium;">
                                                    ...
                                                    $html.= '<img src="'.$imgGrafico1.'" class="text-center" height="350px" alt="img">';

                                                    $html.= '<img src="'.$imgGrafico2.'" class="text-center" height="350px" alt="img">';
...
function sendmail($nomeCliente, $nomeForm, $resultado){
    ...
    $comcopia          = trim('financeiro@businessperformance.com.br');
...
<!--Morris Chart CSS -->   
        ...
        $.post("../controller/assessment_lideranca.php", {'tokenForm':'<?php echo $_POST['tokenForm'] ?>', 'tokenCliente':'<?php echo $_POST['tokenCliente'] ?>', 'op':2}, function(data)

        {
            ...
            swal({   
                ...
                text: "Assessment respondido com sucesso! Avance para realizar o download do resultado. ",
                ...
                window.location.href="http://www.businessperformance.net.br/resultado-assessment-<?php echo $_POST['tokenForm']?>-<?php echo $_POST['tokenCliente']?>";
