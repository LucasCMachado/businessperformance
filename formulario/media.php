...
<script type="text/javascript">
    $('#enviar').on('click', function(event) {
        ...
        if (qtdBranco>1) {
            ...
            $.post("../controller/formulario.php", {'formulario':'<?php echo $_GET['tokenFormulario'] ?>', 'cliente':'<?php echo $_GET['tokenCliente'] ?>', 'op':5}, function(data)
            {
               
                if (data=='1') {
                    swal({   
                    title: 'Importante',
                    text: "Assessment já respondido! Clique em avançar para continuar.",
                    type: 'warning',   
                    ...
                    closeOnConfirm: true 
                        ...
                        //alert(data);
                        window.location.href="http://www.businessperformance.net.br/assessment-respondido-<?php echo $_GET['tokenFormulario'] ?>-<?php echo $_GET['tokenCliente'] ?>";
                    });
                }else{
                    $.post("../controller/formulario.php", $('#form').serialize()).done(function(data){
                        swal({   
                            title: 'Sucesso',
                            text: "Formulário enviado com sucesso! Você será redirecionado para seu resultado.",
                            type: 'success',   
                            showCancelButton: false,   
