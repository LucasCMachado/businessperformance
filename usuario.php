    ...
    <body>
        ...
        <section class="content">            
            ...
            <div class="wraper container-fluid">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="bg-picture" style="background-image:url('img/img_bg_1.png')">
                        ...
                        <div class="panel panel-default p-0">
                            <div class="panel-body p-0"> 
                                <ul class="nav nav-tabs profile-tabs">
                                    ...
                                    <li class=""><a data-toggle="tab" href="#senha-compra"><i class="fa fa-plus"></i> Novo usuário</a></li>
                                </ul>
                                ...
                                <div id="senha-compra" class="tab-pane">
                                    <div class="user-profile-content">
                                        <form role="form" id='senha-compra-EditForm' action="#" role="form">
                                            <div class="form-group">
                                                <label for="nome">Nome</label>
                                                <input type="text" placeholder="Nome do usuário" id="nome" class="form-control">
                                            </div>
                                            <div class="form-group">
                                                <label for="nome">E-mail</label>
                                                <input type="email" placeholder="E-mail" id="nome" class="form-control">
                                            </div>
                                            <button class="btn btn-primary" type="submit">Salvar</button>
                                        </form>
                                    </div>
