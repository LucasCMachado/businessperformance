                    ...
                    <div class="dropdown-header pb-3">
                        <div class="media d-user">
                            ...
                            <div class="media-body">
                                <h5 class="mt-0 mb-0">Nome<?php echo $nome;?></h5>
                                <span>Sobrenome<?php echo $ramal;?></span>
                            </div>
                        </div>
                    </div>
                    <a class="dropdown-item" href="pages.my-account.html"><i class="icon dripicons-gear"></i> Configurações de conta </a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="auth.sign-in.html"><i class="icon dripicons-exit"></i> Sair</a>
                </div>
            </li>
            <li class="nav-item">
            </li>
